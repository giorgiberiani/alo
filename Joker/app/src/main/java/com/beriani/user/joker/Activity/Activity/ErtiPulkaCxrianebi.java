...
public class ErtiPulkaCxrianebi extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        positive_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ErtiPulkaCxrianebi.this.finish();
    ...
    int j = 0, i = 0,xisht = 0,premiebis_raodenoba = 0,sum = 0 ,taken_sum = 0, row =0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_erti_pulka_cxrianebi);
        ...
        final TextView[] textViews1 = {tx1, tx2, tx3, tx4, tx5, tx6, tx7, tx8, tx9, tx10, tx11, tx12, tx13, tx14, tx15, tx16, tx17, tx18, tx19, tx20, tx21, tx22, tx23, tx24, tx25, tx26, tx27, tx28, tx29, tx30, tx31, tx32};
    ...
    private void on_button_click(TextView[] textViews1, TextView info_textview, final String couple_switch,
                                final String remove_last_switch, int button_number, String waigo, String ver_waigo, TextView[] names_textview_array) {


        int shetenva_waglejva_shevseba;
...
//
                    ...
                    if (taken_sum == 9) {
                        ...
                        switch (row%4){
                            ...
                            case 1 :  info_textview.setText(getString(R.string.arigebs)+" "+names_textview_array[0].getText().toString()); break;
                            case 2 :  info_textview.setText(getString(R.string.arigebs)+" "+names_textview_array[1].getText().toString()); break;
                            case 3 :  info_textview.setText(getString(R.string.arigebs)+" "+names_textview_array[2].getText().toString()); break;
                            case 0 :  info_textview.setText(getString(R.string.arigebs)+" "+names_textview_array[3].getText().toString()); break;
                        }
        ...
        if (i == 32) {
            ...
            if (!couple_switch.equals("true")) {
                ...
                result_value_textview_0.setText(sum1.getText());
                result_value_textview_1.setText(sum2.getText());
                result_value_textview_2.setText(sum3.getText());
                result_value_textview_3.setText(sum4.getText());
                ...
                button_save.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        boolean isinserted =    result_database.insert_data(name_textview_0.getText().toString(), name_textview_1.getText().toString(),name_textview_2.getText().toString(),name_textview_3.getText().toString(),
                               Double.parseDouble(sum1.getText().toString()), Double.parseDouble(sum2.getText().toString()), Double.parseDouble(sum3.getText().toString()), Double.parseDouble(sum4.getText().toString()),
                                date,getResources().getString(R.string.cxrianebi),0,0.0,0.0);
                ...
                button_save.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        boolean isinserted =    result_database.insert_data(name_textview_0.getText().toString(), name_textview_1.getText().toString(),name_textview_2.getText().toString(),name_textview_3.getText().toString(),
                                0.0, 0.0, 0.0, 0.0,
                                date,getResources().getString(R.string.cxrianebi),1,Double.parseDouble(sum1.getText().toString()),Double.parseDouble(sum2.getText().toString()));
        ...
        Log.e("first",""+first_player_max_value+"\n");
        Log.e("first index",""+first_player_max_value_index+"\n");
        Log.e("second",""+second_player_max_value+"\n");
        Log.e("second index",""+second_player_max_value_index+"\n");
        Log.e("third",""+third_player_max_value+"\n");
        Log.e("third index",""+third_player_max_value_index+"\n");
        Log.e("fourth",""+fourth_player_max_value+"\n");
        Log.e("fourth index",""+fourth_player_max_value_index+"\n");
